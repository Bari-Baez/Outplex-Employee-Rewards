...
import { RAFFLE_RUNTIME_KEY_PREFIX, type RaffleFormState, type RaffleParticipant } from '@backend/modules/raffles/domain/runtime';
import type { NotificationType, StoreThemeConfig, User, UserRole } from '@shared/contracts/database';
import { createServiceClient } from '@backend/platform/supabase/server';
import {
  DEMO_PASSWORD,
  PRESENTATION_DEMO_USERS,
  type PresentationDirectoryUser,
  type PresentationStatus,
} from '@backend/modules/simulation/contracts/presentation';

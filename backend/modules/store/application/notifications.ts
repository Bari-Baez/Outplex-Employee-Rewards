...
import type { StoreItem } from '@shared/contracts/database';
import { LOW_STOCK_THRESHOLD } from '@backend/modules/store/domain/catalog';
import { MODERATOR_ROLES } from '@backend/modules/access/domain/roles';

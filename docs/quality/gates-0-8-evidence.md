...
| 4 — Plataforma/CI | **PASS en repositorio** | `npm ci`, predeploy, TypeScript, ESLint 0 errores/78 warnings, 21/21 tests, build Next.js 16.2.12, OpenAPI estricto, 6/6 Playwright, CodeQL, dependency review, audits y SBOM. | Branch protection y ejecución verde del proveedor son controles externos. |

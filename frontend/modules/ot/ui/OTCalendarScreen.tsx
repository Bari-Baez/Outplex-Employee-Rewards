...
import { getOTClaimKindLabel, type OTClaimKind } from '@backend/modules/ot/domain/claim-kind';
import type { OTSlot, UserRole } from '@shared/contracts/database';
import { formatOTDate } from '@backend/modules/ot/domain/time';
import { getCalendarDays, getLastDayOfMonth, isSameDay, isToday, toDateString } from '@frontend/shared/lib/date';
import { formatRelativeTime, formatTime } from '@shared/utils/format';
import { getUnclaimWindowRemainingMs } from '@backend/modules/ot/domain/schedule';
...
export function OTCalendarScreen() {
  return (
    <Suspense>

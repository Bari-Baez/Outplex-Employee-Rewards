...
import { formatPoints, getStockLabel } from '@backend/modules/store/domain/catalog';
import { PurchaseOverlay } from '@frontend/shared/ui/PurchaseOverlay';
import { useAppStore, type CartItem } from '@frontend/modules/shell/state/app-store';
